...
class heap() :
    def __init__ (self):
        ...
        self.hashtable={} #словарь, в котором будут храниться пары ключ-значение(поскольку в python словарь реализован хэш-таблицей,операция добавления происходит за амортизированную O(1), а доступ к элементу за O(1).
    def add(self, k, v) :
